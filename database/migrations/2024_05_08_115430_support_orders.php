...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('support_orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('client_ciampi_id');
            $table->unsignedBigInteger('client_freddo_id');
            $table->unsignedBigInteger('client_glasse_id');
            ...
            $table->foreign('client_ciampi_id')->references('id')->on('clients_ciampi');
            $table->foreign('client_freddo_id')->references('id')->on('clients_freddo');
            $table->foreign('client_glasse_id')->references('id')->on('clients_glasse');
